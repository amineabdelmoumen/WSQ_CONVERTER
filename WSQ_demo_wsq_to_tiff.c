...
// gcc -m64 -o WSQ_demo_wsq_to_tiff.o  WSQ_demo_wsq_to_tiff.c -ldl
//  or
// gcc -m64 -ldl -o WSQ_demo_wsq_to_tiff.o  WSQ_demo_wsq_to_tiff.c
//
// To run the program use the command line
// ./WSQ_demo_wsq_to_tiff.o
...
int main()
{
        ...
        char* output_file_name = "./output_image_1";
...
//=============
        ...
        printf("%s\n", "Output image is saved to file \"output_image_1.tif\"");
        return 1;
