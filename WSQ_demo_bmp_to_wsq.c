...
// gcc -m64 -o WSQ_demo_bmp_to_wsq.o  WSQ_demo_bmp_to_wsq.c -ldl
//  or
// gcc -m64 -ldl -o WSQ_demo_bmp_to_wsq.o  WSQ_demo_bmp_to_wsq.c
//
// To run the program use the command line
// ./WSQ_demo_bmp_to_wsq.o
...
int main(char* input_file_name ,char* output_file_name)
{
